...
public class Demo {
	...
	public static void write() throws Exception {
		...
		File file = new File("C:\\Users\\matei\\Desktop\\UCM_Informatica\\java\\assigment 1\\asdaasda.ini");
	...
	public static void read() throws Exception {
		...
		File file = new File("C:\\Users\\matei\\Desktop\\UCM_Informatica\\java\\assigment 1\\out.ini");
	...
	public static void compare() throws Exception {
		...
		Ini[] ini = new Ini[5];
			...
			ini[0] = new Ini(new FileInputStream(new File("C:\\Users\\matei\\Desktop\\UCM_Informatica\\java\\examples\\basic\\0.ini")));
